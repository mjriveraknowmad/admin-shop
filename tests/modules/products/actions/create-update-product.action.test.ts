...
describe('createUpdateProductAction', () => {
  ...
  test('should upload product image', async () => {
    const imagePath = path.join(__dirname, '../../../fake', 't-shirt.jpg'); // __dirname es el directorio actual del test, por lo que hay que subir dos niveles para llegar a la raíz del proyecto y luego entrar en fake para coger la imagen
